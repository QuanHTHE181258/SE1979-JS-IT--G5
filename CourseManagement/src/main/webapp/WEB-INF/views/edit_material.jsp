...
<div class="wrapper">
    ...
    <div id="content">
        <div class="add-material-container">
            ...
            <form action="${pageContext.request.contextPath}/edit-material" method="post" enctype="multipart/form-data">
                <input type="hidden" name="id" value="${material.id}" />
                <input type="hidden" name="lessonId" value="${material.lessonId}" />
                <label for="title" class="form-label">Material Title</label>
                <input type="text" id="title" name="title" class="form-control" required value="${material.title}" placeholder="Enter material title..." />

                <label for="fileUrl" class="form-label">File URL</label>
                <input type="text" id="fileUrl" name="fileUrl" class="form-control" value="${material.fileURL}" placeholder="Enter file URL or upload new file..." />
                ...
                <div class="form-actions">
                    ...
                    <a href="${pageContext.request.contextPath}/lesson-details?id=${material.lessonId}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
