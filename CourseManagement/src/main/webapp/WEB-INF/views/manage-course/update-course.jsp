...
<div class="form-container">
    <div class="form-title">
        <i class="fas fa-edit form-icon"></i> Update Course
    </div>
    <form action="update-course" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group form-section">
            ...
            <input type="text" class="form-control" name="title" value="${course.title}" required maxlength="255">
        ...
        <div class="form-group form-section">
            ...
            <textarea class="form-control" name="description" required maxlength="2000" rows="3">${course.description}</textarea>
        ...
        <div class="form-group form-section">
            ...
            <select class="form-select" name="categoryId" required>
                ...
                <c:forEach var="cat" items="${categories}">
                    <option value="${cat.id}" ${cat.id == course.categoryId ? 'selected' : ''}>
        ...
        <div class="form-group form-section">
            ...
            <select class="form-select" name="instructorId" required>
                ...
                <c:forEach var="ins" items="${instructors}">
                    <option value="${ins.id}" ${ins.id == course.instructorId ? 'selected' : ''}>
        ...
        <div class="form-group form-section">
            ...
            <input type="hidden" name="oldImage" value="${course.imageURL}" />
            <c:if test="${not empty course.imageURL}">
                <div class="mt-2"><img src="${pageContext.request.contextPath}/${course.imageURL}" alt="Current Image" style="max-width:120px;max-height:80px;border-radius:8px;"></div>
            </c:if>
            <c:if test="${not empty errors.image}"><span class="error">${errors.image}</span></c:if>
        </div>
        <div class="form-group text-center">
            <button type="submit" class="btn btn-create me-2"><i class="fas fa-save me-2"></i>Update</button>
